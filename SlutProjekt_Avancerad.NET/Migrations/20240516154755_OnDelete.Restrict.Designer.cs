...
namespace SlutProjekt_Avancerad.NET.Migrations
{
    ...
    [Migration("20240516154755_OnDelete.Restrict")]
            ...
            modelBuilder.Entity("ClassModels.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ApointmentID = 1,
                            AppointmentDate = new DateTime(2024, 5, 16, 17, 47, 55, 641, DateTimeKind.Local).AddTicks(5980),
                            AppointmentStatus = 0,
                            AppointmentType = 0,
                            CompanyID = 2,
                            CustomerID = 1
                        ...
                        {
                            ApointmentID = 2,
                            AppointmentDate = new DateTime(2024, 5, 16, 17, 47, 55, 641, DateTimeKind.Local).AddTicks(6048),
                            AppointmentStatus = 2,
                            AppointmentType = 2,
                            CompanyID = 3,
                            CustomerID = 2
                        ...
                        {
                            ApointmentID = 3,
                            AppointmentDate = new DateTime(2024, 5, 16, 17, 47, 55, 641, DateTimeKind.Local).AddTicks(6059),
                            AppointmentStatus = 1,
                            AppointmentType = 1,
                            CompanyID = 1,
                            CustomerID = 3
