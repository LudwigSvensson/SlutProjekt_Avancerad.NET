...
namespace SlutProjekt_Avancerad.NET.Migrations
{
    ...
    [Migration("20240516093203_Added History ClassModel")]
    partial class AddedHistoryClassModel
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("ClassModels.Appointment", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            ApointmentID = 1,
                            AppointmentDate = new DateTime(2024, 5, 16, 11, 32, 3, 321, DateTimeKind.Local).AddTicks(5464),
                            AppointmentStatus = 0,
                            AppointmentType = 0,
                            CompanyID = 2,
                            CustomerID = 1
                        ...
                        {
                            ApointmentID = 2,
                            AppointmentDate = new DateTime(2024, 5, 16, 11, 32, 3, 321, DateTimeKind.Local).AddTicks(5501),
                            AppointmentStatus = 2,
                            AppointmentType = 2,
                            CompanyID = 3,
                            CustomerID = 2
                        ...
                        {
                            ApointmentID = 3,
                            AppointmentDate = new DateTime(2024, 5, 16, 11, 32, 3, 321, DateTimeKind.Local).AddTicks(5511),
                            AppointmentStatus = 1,
                            AppointmentType = 1,
                            CompanyID = 1,
                            CustomerID = 3
